...
public class Card {
	...
	boolean set(char value, Suit suit){ // a mutator that accepts the legal values established in the earlier section. 
		return true;					// When bad values are passed, errorFlag is set to true and other values can be 
	...
	private boolean isValid(char value, Suit suit){
		return true;					//a private helper method that returns true or false, depending on the legality 
